...
func TestNewRegexKeyFilter(t *testing.T) {
	...
	filter, err := NewRegexKeyFilter(`^f.*`, true)
	if err != nil {
...
func TestNewRegexKeyFilterInvert(t *testing.T) {
	...
	filter, err := NewRegexKeyFilter(`^f.*`, false)
	if err != nil {
		assert.FailNow(t, err.Error())
	}
...
func TestNewListKeyFilter(t *testing.T) {
	...
	filter, err := NewListKeyFilter([]string{"foo", "baz"}, true)
	if err != nil {
		assert.FailNow(t, err.Error())
	}
...
func TestNewListMultilevelKeyFilter(t *testing.T) {
	...
	filter, err := NewListKeyFilter([]string{"foo", "baz", "booze"}, true)
	if err != nil {
		assert.FailNow(t, err.Error())
	}
