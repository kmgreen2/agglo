...
var file_ticker_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x2a, 0x2b, 0x0a, 0x0a, 0x44, 0x69, 0x67, 0x65, 0x73, 0x74,
	...
	0x35, 0x10, 0x02, 0x32, 0xc4, 0x03, 0x0a, 0x06, 0x54, 0x69, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x52,
	...
	0x62, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x44, 0x7d, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x3b,
...
var file_ticker_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_ticker_proto_depIdxs = []int32{
	...
	4,  // 8: ticker.Ticker.Anchor:output_type -> ticker.AnchorResponse
	6,  // 9: ticker.Ticker.Tick:output_type -> ticker.TickResponse
	8,  // 10: ticker.Ticker.GetProofStartUuid:output_type -> ticker.GetProofStartUuidResponse
	10, // 11: ticker.Ticker.CreateGenesisProof:output_type -> ticker.CreateGenesisProofResponse
